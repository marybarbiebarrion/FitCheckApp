...
class User(AbstractUser):
    ...
    allergy_name = models.CharField(max_length=255, null=True, blank=True, default="Sesame")  # Name of allergy
    ...
    daily_caloric_intake = models.IntegerField(null=True, blank=True, default=2000)
