...
INSERT INTO "NutritionGuidance_allergen" (allergen_name) VALUES ('Sesame');
INSERT INTO "NutritionGuidance_allergen" (allergen_name) VALUES ('Nuts');
...
INSERT INTO "NutritionGuidance_recipe_ingredients" (quantity, ingredient_id_id, recipe_id_id) VALUES ('50 mL', (SELECT ingredient_id FROM "NutritionGuidance_ingredient" WHERE ingredient_name = 'White Rice'), (SELECT recipe_id FROM "NutritionGuidance_recipe" WHERE recipe_instructions = 'boo! gotcha didnt i?'));
...
INSERT INTO "NutritionGuidance_meal" (meal_name, calories, allergen_id_id, recipe_id_id) VALUES ('Nutty Chocolate', 200, (SELECT allergen_id FROM "NutritionGuidance_allergen" WHERE allergen_name = 'Nuts'), (SELECT recipe_id FROM "NutritionGuidance_recipe" WHERE recipe_instructions = 'then i walk back home from burger king'));
INSERT INTO "NutritionGuidance_meal" (meal_name, calories, allergen_id_id, recipe_id_id) VALUES ('Korean Beef Bowl', 300, (SELECT allergen_id FROM "NutritionGuidance_allergen" WHERE allergen_name = 'Sesame'), (SELECT recipe_id FROM "NutritionGuidance_recipe" WHERE recipe_instructions = 'i walk to burger king'));
...
INSERT INTO "NutritionGuidance_meal" (meal_name, calories, recipe_id_id) VALUES ('Filler Meal 3', 200, (SELECT recipe_id FROM "NutritionGuidance_recipe" WHERE recipe_instructions = 'boo! gotcha didnt i?'));
...
INSERT INTO "NutritionGuidance_meal" (meal_name, calories, recipe_id_id) VALUES ('Filler Meal 8', 200, (SELECT recipe_id FROM "NutritionGuidance_recipe" WHERE recipe_instructions = 'boo! gotcha didnt i?'));
